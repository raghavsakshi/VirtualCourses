...
function ExploreCourses() {
  ...
  return (
    <div className='w-[100vw] min-h-[50vh] lg:h-[50vh] flex flex-col lg:flex-row items-center
    ...
    <div className='w-[100%] lg:w-[350px] lg:h-[100%] h-[400px]
     flex flex-col items-start justify-center gap-1 md:px-[40px] px-[20px]'>
        ...
        <p className='text-[17px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt sequi consequuntur error sapiente iure nostrum voluptates 
            ea deleniti fugit rerum a perspiciatis, velit quasi reprehenderit!</p>
        <button className='px-[20px] py-[10px] border-2 bg-[black] border-white text-white rounded-[10px]
        text-[18px] font-light flex gap-2 mt-[40px] cursor-pointer' onClick={()=>navigate("/allcourses")}>Explore Courses
        <SiViaplay  className='w-[30px] h-[30px] fill-white '/></button>
     </div>
{/*right/bottom div*/}
<div className='w-[720px] max-w-[90%] lg:h-[300px] md:min-h-[300px] flex items-center 
...
< MdOutlineAppShortcut  className='w-[50px] h-[50px] text-[#6d6c6c]' />
        </div>
        App Dev
    </div>
...
<SiGoogledataproc className='w-[50px] h-[50px] text-[#6d6c6c]' />
    ...
    <div className='w-[100px] h-[130px] font-light text-[13px] flex flex-col gap-3 text-center'>
        <div className='w-[100px] h-[90px] bg-[#fcb9c8] rounded-lg flex items-center justify-center'>
<BsDatabaseCheck className='w-[50px] h-[50px] text-[#6d6c6c]' />
        </div>
        Data Analytics
    </div>
