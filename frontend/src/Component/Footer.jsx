...
function Footer() {
  ...
  return (
    <div className='bg-black text-gray-300 py-10 px-6'>
      <div className='max-w-7xl mx-auto flex lg:items-center items-start justify-
      ...
      <div className='border-t border-gray-700 mt-10 pt-5 text-sm text-center text-gray-500'>&copy;
        { new Date().getFullYear()} LearnAI. All rights reserved.</div>
    </div>
  )
}
